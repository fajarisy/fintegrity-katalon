...
if (WebUI.verifyElementNotPresent(findTestObject('CDB/Personal/HomeTaskCDBCompany/TableTask'), GlobalVariable.wait_medium_time, 
    FailureHandling.OPTIONAL)) {
    'Prevent Panel Task jika belum terbuka'
    WebUI.waitForElementClickable(findTestObject('CDB/Personal/HomeTaskCDBCompany/OpenTask'), GlobalVariable.wait_medium_time, 
        FailureHandling.STOP_ON_FAILURE)

    CustomKeywords.'customKeywords.CustomKeywordJS.clickUsingJS'(findTestObject('CDB/Personal/HomeTaskCDBCompany/OpenTask'), 
        GlobalVariable.wait_js_long_time)
//
//    'Antisipasi bila muncul warning no task berwarna merah'
//    WebUI.waitForElementPresent(findTestObject('Object Repository/HomeTaskWarnings/CDBCompany'), 
//        GlobalVariable.wait_medium_time, FailureHandling.OPTIONAL)

//    if (WebUI.verifyElementPresent(findTestObject('Object Repository/HomeTaskWarnings/CDBCompany'), 
//        10, FailureHandling.OPTIONAL)) {
//        CustomKeywords.'customKeywords.CustomKeywordJS.clickUsingJS'(findTestObject('Object Repository/HomeTaskWarnings/CDBCompany'), 
//			GlobalVariable.wait_js_long_time)
//
//        WebUI.delay(GlobalVariable.wait_short_time)
//    } 
...
//WebUI.waitForElementPresent(findTestObject('CDB/Personal/HomeTaskCDBCompany/LastPage'), GlobalVariable.wait_long_time, 
//    FailureHandling.OPTIONAL)

//if (WebUI.verifyElementPresent(findTestObject('CDB/Personal/HomeTaskCDBCompany/LastPage'), GlobalVariable.wait_short_time, 
//    FailureHandling.OPTIONAL)) {
//    'Last Page of Table'
//    if (WebUI.verifyElementClickable(findTestObject('CDB/Personal/HomeTaskCDBCompany/LastPage'), FailureHandling.OPTIONAL)) {
//        CustomKeywords.'customKeywords.CustomKeywordJS.clickUsingJS'(findTestObject('CDB/Personal/HomeTaskCDBCompany/LastPage'), 
//            GlobalVariable.wait_js_long_time)
//
...
WebUI.waitForElementPresent(findTestObject('CDB/Personal/HomeTaskCDBCompany/TableTask'), GlobalVariable.wait_long_time, 
    FailureHandling.STOP_ON_FAILURE)
...
'To locate table'
WebElement Table = driver.findElement(By.xpath('//*[@id="frmMain:dtCifCorporate:tb"]'))
