...
not_run: WebUI.callTestCase(findTestCase('LoginLogout/Login'), [('username') : BM, ('isOpenBrowser') : false], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('CDB/FloatingButton/ButtonApprove'), [:], FailureHandling.STOP_ON_FAILURE)
