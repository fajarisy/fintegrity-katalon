...
WebUI.callTestCase(findTestCase('EntryBooking/EntryBooking_Checker'), [('CustomerName') : CustomerName], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('LoginLogout/Logout'), [('isOpenBrowser') : true], FailureHandling.STOP_ON_FAILURE)

'Login Approver'
WebUI.callTestCase(findTestCase('LoginLogout/Login_Enhanced'), [('UserName') : Approver], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('EntryBooking/EntryBooking_Approve'), [('CustomerName') : CustomerName], FailureHandling.STOP_ON_FAILURE)
