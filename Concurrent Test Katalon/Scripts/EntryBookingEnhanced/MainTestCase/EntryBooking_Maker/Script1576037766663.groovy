...
WebUI.waitForElementNotPresent(findTestObject('Object Repository/EntryBooking/Page EB_Maker/MaskLoadingScreen'), GlobalVariable.wait_long_time, 
    FailureHandling.OPTIONAL)

WebUI.waitForElementClickable(findTestObject('EntryBooking/Page EB_Maker/input_frmMainbtnA_wfNextWithou'), GlobalVariable.wait_long_time, 
