...
WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransaction_Maker3'), [('PostingPeriod') : PostingPeriod
...
WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransaction_Approve3'), [('CashTransNo') : CashTransNo], 
...
WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransactionPayment_Maker3'), [('CashTransNo') : CashTransNo
...
not_run: WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransactionPayment_Checker3'), [('CashTransNo') : CashTransNo], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransactionPayment_Approver3'), [('CashTransNo') : CashTransNo], 
    FailureHandling.STOP_ON_FAILURE)
