...
WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransaction_Maker4'), [('PostingPeriod') : PostingPeriod
...
WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransaction_Approve4'), [('CashTransNo') : CashTransNo], 
...
WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransactionPayment_Maker4'), [('CashTransNo') : CashTransNo
...
WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransactionPayment_Checker4'), [('CashTransNo') : CashTransNo], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransactionPayment_Approver4'), [('CashTransNo') : CashTransNo], 
    FailureHandling.STOP_ON_FAILURE)
