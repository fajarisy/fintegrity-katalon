...
if (WebUI.verifyElementPresent(findTestObject('Object Repository/Internal Payment - Cash Transaction/Maker Cash Transaction Payment/Task_Panel_Maker/Show_Task_Table_CTPayment'),
