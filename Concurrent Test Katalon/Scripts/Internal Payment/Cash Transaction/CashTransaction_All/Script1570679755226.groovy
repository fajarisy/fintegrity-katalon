...
WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransaction_Maker'), [('PostingPeriod') : PostingPeriod
...
WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransaction_Approve'), [('CashTransNo') : CashTransNo], 
...
WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransactionPayment_Maker'), [('CashTransNo') : CashTransNo
...
not_run: WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransactionPayment_Checker'), [('CashTransNo') : CashTransNo], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransactionPayment_Approver'), [('CashTransNo') : CashTransNo], 
    FailureHandling.STOP_ON_FAILURE)
