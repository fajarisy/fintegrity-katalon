...
WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransaction_Maker2'), [('PostingPeriod') : PostingPeriod
...
WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransaction_Approve2'), [('CashTransNo') : CashTransNo], 
...
WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransactionPayment_Maker2'), [('CashTransNo') : CashTransNo
...
not_run: WebUI.callTestCase(findTestCase('LoginLogout/Login'), [('username') : CheckerCTPayment, ('isOpenBrowser') : true], 
    FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransactionPayment_Checker2'), [('CashTransNo') : CashTransNo], 
    FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('LoginLogout/Logout'), [('isOpenBrowser') : true], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransactionPayment_Approver2'), [('CashTransNo') : CashTransNo], 
    FailureHandling.STOP_ON_FAILURE)
