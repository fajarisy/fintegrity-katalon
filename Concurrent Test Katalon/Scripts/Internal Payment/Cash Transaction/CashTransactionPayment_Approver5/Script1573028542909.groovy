...
if (WebUI.verifyElementNotPresent(findTestObject('Object Repository/Internal Payment - Cash Transaction/Approver Cash Transaction Payment/Task Panel Payment Approver/Show_Task_Table_CTPayment'),
