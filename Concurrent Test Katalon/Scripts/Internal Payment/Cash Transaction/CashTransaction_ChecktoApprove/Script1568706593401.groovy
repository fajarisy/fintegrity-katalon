...
WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransaction_Approve'), [('CashTransNo'): CashTransNo], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransactionPayment_Maker'), [('CashTransNo'): CashTransNo], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransactionPayment_Checker'), [('CashTransNo'): CashTransNo], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Internal Payment/Cash Transaction/CashTransactionPayment_Approver'), [('CashTransNo'): CashTransNo], FailureHandling.STOP_ON_FAILURE)
