...
WebUI.callTestCase(findTestCase('Payment/CashTransfer/PaymentCashTransfer_Maker'), [('SearchCDB') : SearchCDB, ('CDB') : CDB
        ...
        , ('Installment') : Installment, ('FacilityNo') : FacilityNo, ('InstallmentTo') : InstallmentTo], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Payment/CashTransfer/PaymentCashTransfer_Approve'), [('LesseeName') : LesseeName], FailureHandling.STOP_ON_FAILURE)
