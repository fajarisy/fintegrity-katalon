...
WebUI.callTestCase(findTestCase('Procurement/PurchaseRequisition/HomeTaskandMenu/MainMenuPurchaseRequisition/SelectMenuPurchaseRequisition'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Procurement/PurchaseRequisition/PurchaseRequisitionForm/PurchaseRequisitionHeader/PurchaseRequisitionHeader'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Procurement/PurchaseRequisition/PurchaseRequisitionForm/PurchaseRequisitionItem/PurchaseRequisitionItem'), 
    [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Procurement/PurchaseRequisition/PRForm/PRNo'), GlobalVariable.wait_long_time)
...
FileOutputStream outFile = new FileOutputStream(new File('D:\\TestDataKatalon\\Procurement\\_tmp.xlsx'))
