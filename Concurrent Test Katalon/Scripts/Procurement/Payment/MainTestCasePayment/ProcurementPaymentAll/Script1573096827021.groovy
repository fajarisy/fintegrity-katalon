...
WebUI.callTestCase(findTestCase('Procurement/Payment/MainTestCasePayment/GaMaker'), [('GaMaker') : GaMaker, ('PRno') : PRno], 
...
WebUI.callTestCase(findTestCase('Procurement/Payment/MainTestCasePayment/GaChecker'), [('GaChecker') : GaChecker, ('PRno') : PRno], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Procurement/Payment/MainTestCasePayment/FinMaker'), [('FinMaker') : FinMaker, ('PRno') : PRno], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Procurement/Payment/MainTestCasePayment/FinChecker'), [('FinChecker') : FinChecker, ('PRno') : PRno], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Procurement/Payment/MainTestCasePayment/FinDir'), [('FinDir') : FinDir, ('PRno') : PRno], 
    FailureHandling.STOP_ON_FAILURE)
