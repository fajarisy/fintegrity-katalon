...
WebUI.callTestCase(findTestCase('Procurement/RegisterInvoice/MainTestCaseInvoice/GaMaker'), [('GaMaker') : GaMaker, ('PRno') : PRno], 
...
WebUI.callTestCase(findTestCase('Procurement/RegisterInvoice/MainTestCaseInvoice/GaChecker'), [('GaChecker') : GaChecker], 
    FailureHandling.STOP_ON_FAILURE)
