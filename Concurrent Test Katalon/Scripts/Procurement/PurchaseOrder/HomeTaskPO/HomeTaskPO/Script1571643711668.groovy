...
WebUI.callTestCase(findTestCase('LoginLogout/Login'), [('username') : 'NATALIA', ('isOpenBrowser') : false, ('finPass') : 'Mbf137??'], 
...
if (WebUI.verifyElementNotPresent(findTestObject('Object Repository/Procurement/PurchaseOrder/HomeTaskPO/TableBodyTaskPo'), 
    ...
    WebUI.waitForElementClickable(findTestObject('Object Repository/Procurement/PurchaseOrder/HomeTaskPO/OpenTaskPO'), 
        GlobalVariable.wait_js_long_time)
