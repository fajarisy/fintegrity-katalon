...
'Login Maker VA9 Payment Maker'
WebUI.callTestCase(findTestCase('LoginLogout/Login'), [('username') : Maker], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('VA Payment/VA Payment 9/VAPayment 9_Maker3'), [('ReceivingBank') : ReceivingBank], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('VA Payment/VA Payment 9/VAPayment9_Checker'), [('UploadDate') : UploadDate, ('TotalTransaction') : TotalTransaction], 
