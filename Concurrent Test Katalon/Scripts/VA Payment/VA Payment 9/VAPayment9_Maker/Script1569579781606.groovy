...
'Click Upload'
WebUI.sendKeys(findTestObject('VA Payment/VA Payment Maker/open_folder_VA9'), 'D:\\JEANE\\LOCAL\\VA Upload\\VA UPLOAD 9 digit Test 1.xls')
...
'Save'
CustomKeywords.'customKeywords.CustomKeywordJS.clickUsingJS'(findTestObject('VA Payment/VA Payment 14 Maker/save'), 10)
