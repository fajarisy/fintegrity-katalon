...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement02/RegisterInvoice/MainTestCaseInvoice/GaMaker'), [('GaMaker') : GaMaker
...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement02/RegisterInvoice/MainTestCaseInvoice/GaChecker'), [('GaChecker') : GaChecker], 
