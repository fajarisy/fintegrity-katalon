...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement02/PurchaseRequisition/HomeTaskandMenu/MainMenuPurchaseRequisition/SelectMenuPurchaseRequisition'), 
    [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement02/PurchaseRequisition/PurchaseRequisitionForm/PurchaseRequisitionItem/PurchaseRequisitionItem'), 
    [:], FailureHandling.STOP_ON_FAILURE)
...
FileOutputStream outFile = new FileOutputStream(new File('D:\\TestDataKatalon\\Procurement\\_tmp2.xlsx'))
