...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement03/RegisterInvoice/MainTestCaseInvoice/GaMaker'), [('GaMaker') : GaMaker
...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement03/RegisterInvoice/MainTestCaseInvoice/GaChecker'), [('GaChecker') : GaChecker], 
