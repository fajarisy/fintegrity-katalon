...
WebUI.callTestCase(findTestCase('Procurement/Prepayment/MainMenuAndHomeTask/CreatePrepayment'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Procurement/Prepayment/PrepaymentForm/PrepaymentForm'), [('PRno') : ''], FailureHandling.STOP_ON_FAILURE)
