...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement01/PurchaseRequisition/HomeTaskandMenu/MainMenuPurchaseRequisition/SelectMenuPurchaseRequisition'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement02/PurchaseRequisition/PurchaseRequisitionForm/PurchaseRequisitionHeader/PurchaseRequisitionHeader'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement01/PurchaseRequisition/PurchaseRequisitionForm/PurchaseRequisitionItem/PurchaseRequisitionItem'), 
    [:], FailureHandling.STOP_ON_FAILURE)
