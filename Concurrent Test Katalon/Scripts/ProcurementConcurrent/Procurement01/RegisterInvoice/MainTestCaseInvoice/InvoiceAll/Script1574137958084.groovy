...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement01/RegisterInvoice/MainTestCaseInvoice/GaMaker'), [('GaMaker') : GaMaker
...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement01/RegisterInvoice/MainTestCaseInvoice/GaChecker'), [('GaChecker') : GaChecker], 
