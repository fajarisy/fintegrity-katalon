...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement01/Prepayment/MainTestCasePrepayment/GaMakerPrepayment'), 
    [('GaMaker') : GaMaker, ('PRno') : PRno], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement01/Prepayment/MainTestCasePrepayment/GaCheckerPrepayment'), 
...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement01/Prepayment/MainTestCasePrepayment/FinMakerPrepayment'), 
...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement01/Prepayment/MainTestCasePrepayment/FinCheckerPrepayment'), 
...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement01/RegisterInvoice/FinDirectorPrepayment'), [('FinDirector') : FinDirector
