...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement01/Prepayment/MainMenuAndHomeTask/CreatePrepayment'), 
    [('PRno') : PRno, ('GaMaker') : GaMaker], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement01/Prepayment/PrepaymentForm/PrepaymentForm'), [('PRno') : PRno], 
