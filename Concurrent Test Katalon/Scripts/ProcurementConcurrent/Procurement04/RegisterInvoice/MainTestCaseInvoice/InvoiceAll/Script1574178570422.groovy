...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement04/RegisterInvoice/MainTestCaseInvoice/GaMaker'), [('GaMaker') : GaMaker
...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement04/RegisterInvoice/MainTestCaseInvoice/GaChecker'), [('GaChecker') : GaChecker], 
