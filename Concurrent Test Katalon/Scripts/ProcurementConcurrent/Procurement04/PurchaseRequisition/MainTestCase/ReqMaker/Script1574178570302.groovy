...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement04/PurchaseRequisition/HomeTaskandMenu/MainMenuPurchaseRequisition/SelectMenuPurchaseRequisition'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement04/PurchaseRequisition/PurchaseRequisitionForm/PurchaseRequisitionHeader/PurchaseRequisitionHeader'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement04/PurchaseRequisition/PurchaseRequisitionForm/PurchaseRequisitionItem/PurchaseRequisitionItem'), 
    [:], FailureHandling.STOP_ON_FAILURE)
...
FileOutputStream outFile = new FileOutputStream(new File('D:\\TestDataKatalon\\Procurement\\_tmp4.xlsx'))
