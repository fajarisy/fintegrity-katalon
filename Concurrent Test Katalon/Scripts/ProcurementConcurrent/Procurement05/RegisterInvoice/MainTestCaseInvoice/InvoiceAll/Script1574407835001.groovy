...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement05/RegisterInvoice/MainTestCaseInvoice/GaMaker'), [('GaMaker') : GaMaker
...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement05/RegisterInvoice/MainTestCaseInvoice/GaChecker'), [('GaChecker') : GaChecker], 
