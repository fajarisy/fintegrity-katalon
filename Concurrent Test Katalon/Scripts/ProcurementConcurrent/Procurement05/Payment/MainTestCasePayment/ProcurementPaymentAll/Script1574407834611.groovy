...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement05/Payment/MainTestCasePayment/GaMaker'), [('GaMaker') : GaMaker
...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement05/Payment/MainTestCasePayment/GaChecker'), [('GaChecker') : GaChecker
        , ('PRno') : PRno], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement05/Payment/MainTestCasePayment/FinMaker'), [('FinMaker') : FinMaker
        , ('PRno') : PRno], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement05/Payment/MainTestCasePayment/FinChecker'), [('FinChecker') : FinChecker
        , ('PRno') : PRno], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('ProcurementConcurrent/Procurement05/Payment/MainTestCasePayment/FinDir'), [('FinMaker') : FinMaker
        , ('PRno') : PRno], FailureHandling.STOP_ON_FAILURE)
