...
if(WebUI.verifyElementPresent(findTestObject('Object Repository/Facility/CDBPerSlik/HomeTask/WarningNoTaskPerSlik'),GlobalVariable.wait_medium_time,FailureHandling.OPTIONAL)){
	CustomKeywords.'customKeywords.CustomKeywordJS.clickUsingJS'(findTestObject('Object Repository/Facility/CDBPerSlik/HomeTask/WarningNoTaskPerSlik'),GlobalVariable.wait_js_long_time)
	WebUI.delay(GlobalVariable.wait_js_long_time)
}

'Panel Task CDB Per SLik'
if (WebUI.verifyElementNotPresent(findTestObject('Facility/CDBPerSlik/HomeTaskTableBody/CDBPerSlikTableBody'), GlobalVariable.wait_long_time, 
	...
	if(WebUI.verifyElementPresent(findTestObject('Object Repository/Facility/CDBPerSlik/HomeTask/WarningNoTaskPerSlik'),10,FailureHandling.STOP_ON_FAILURE)){
		CustomKeywords.'customKeywords.CustomKeywordJS.clickUsingJS'(findTestObject('Object Repository/Facility/CDBPerSlik/HomeTask/WarningNoTaskPerSlik'),GlobalVariable.wait_js_long_time)
...
if (WebUI.verifyElementPresent(findTestObject('Facility/CDBPerSlik/HomeTask/LastPage'), GlobalVariable.wait_long_time, 
    FailureHandling.OPTIONAL)) {
    'Last Page of Table'
    if (WebUI.verifyElementClickable(findTestObject('Facility/CDBPerSlik/HomeTask/LastPage'), FailureHandling.OPTIONAL)) {
        CustomKeywords.'customKeywords.CustomKeywordJS.clickUsingJS'(findTestObject('Facility/CDBPerSlik/HomeTask/LastPage'), 
            GlobalVariable.wait_js_long_time)
