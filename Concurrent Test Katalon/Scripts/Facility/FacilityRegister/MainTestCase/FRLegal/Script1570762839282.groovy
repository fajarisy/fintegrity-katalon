...
'Login Maker'
not_run: WebUI.callTestCase(findTestCase('LoginLogout/Login'), [('username') : LegalMaker], FailureHandling.STOP_ON_FAILURE)

'Home Task\r\n'
WebUI.callTestCase(findTestCase('Facility/FacilityRegister/HomeTask/FacilityHomeTask'), [('CustomerName') : CustomerName], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Facility/FloatingButton/FacilitySendNextLegal'), [:], FailureHandling.STOP_ON_FAILURE)
